...
reload(sys)
# sys.setdefaultencoding("utf8") # donot exist in python 3.x

from urllib.parse import urlencode
from flask import jsonify, redirect, url_for, abort, request, render_template

from OJ import oj, controller
from OJ.models import User, Problem, File, FileParser
from OJ.controller import Paginate, Tools
